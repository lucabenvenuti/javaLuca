...
public class test {
	...
	//	DoublyLinkedPlaceList DoublyLinkedPlaceListTest =  new DoublyLinkedPlaceList();
		ScreenRow screenRow1 = new ScreenRow(new Category('A'), "####X##########", 1);
		ScreenRow screenRow2 = new ScreenRow(new Category('B'), "###############", 2);
		ScreenRow screenRow3 = new ScreenRow(new Category('C'), "###############", 3);
	//	System.out.println(screenRow1.isEmptySeat(5));
		...
		System.out.println(screen.book(3,5,1));
