 ...
 * left, right or both Receivers can be set after instantiation. The remaining
 * fields (Consumer<A> onReceive, Predicate<A> predicate, Consumer<A> onSend)
...
public class Branch<A> implements Receiver<A> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see second.Receiver#receive(java.lang.Object). predicate.test(a))
	 *      applies the filter function. left.receive(a) passes the value to the
	 *      whatEver left component right.receive(a) passes the value to the
	 *      whatEver right component
	 */
	@Override
